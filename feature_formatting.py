...
from utils import gather_features, gather_ct_features, fix_neg, add_distribution, flatten_list, return_proportion
...
for cov_outlook in cov_outlooks[:1]:
    ...
    df_out.to_csv(f'../prediction-percs/{otlkdt_formatted}_pred-percs.csv',index=False)
